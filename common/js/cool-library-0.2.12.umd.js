    ...
    var UploadHelper = /** @class */ (function () {
        ...
        UploadHelper.prototype.uploadFileByOrigin = function (formData) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.uploadFileByOriginWithServiceType(formData, '')];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        UploadHelper.prototype.uploadFileByOriginWithServiceType = function (formData, serviceType) {
            return __awaiter(this, void 0, void 0, function () {
                var result, serviceTypeStr;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            result = {};
                            serviceTypeStr = serviceType ? serviceType : formData.get("serviceType");
                            return [4 /*yield*/, $$1.ajax({
                                    ...
                                    success: function (response) {
                                        ...
                                        for (var i = 0; i < response.data.length; i++) {
                                            ...
                                            result[i] = COOLFILE_URL + '/originHost/' + serviceTypeStr + '/' + fileHelper.getBaseName(data.originFileName);
                                        }
                                    }
                                })];
                        case 1:
...
//# sourceMappingURL=cool-library-0.2.12.umd.js.map
