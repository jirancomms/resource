                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!(Object.keys(logoutOpts).length > 0)) return [3 /*break*/, 5];
    ...
    var UploadHelper = /** @class */ (function () {
        ...
        UploadHelper.prototype.uploadFileByOrigin = function (formData) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    // @ts-ignore
                    return [2 /*return*/, this.uploadFileByOriginWithServiceType(formData, '')];
                });
            });
        };
...
//# sourceMappingURL=cool-library-0.2.6.umd.js.map
